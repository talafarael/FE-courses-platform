        ...
        <div className="w-[650px] h-[350px] bg-purplelight rounded-3xl border-2 border-purple p-6 flex flex-col justify-between">
            ...
            <div className="flex items-center gap-6 mt-2">
                ...
                <div className="flex flex-col">
                    <p className="text-xl font-semibold text-dark">Анонімний користувач</p>
                    <p className="text-base text-gray-600">Статистика недоступна для анонімних користувачів</p>
                </div>
            </div>
