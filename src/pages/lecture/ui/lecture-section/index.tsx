  ...
  return (
    <div className='w-[100%] flex justify-center items-center'>
      <div className="w-[83vw] max-w-[1200px] h-[53vh] bg-[#DFD5EC] flex flex-col justify-center items-center rounded-[10px]">
        <div className="w-[70vw] max-w-[1200px] flex justify-between">
          <div>
        ...
        <div className="w-[70vw] h-[40vh] bg-questPurple flex justify-center items-center rounded-[10px]">
          <ItemLectureSection lectureSection={currentUnit?.lecture?.sections[currentLectureSectionIndex]} />
        </div>
        <div className="w-[70vw] max-w-[1200px]">
          <Button handlerEvent={handlerPreviousLectureSection} label="Назад" />
